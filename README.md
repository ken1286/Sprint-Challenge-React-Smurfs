...
- [ ] Explain the differences between `client-side routing` and `server-side routing`.
  ...
  With client side, the browsers gets all the data up front and can switch pages quickly. With server side, the server handles the data and pages can take longer to load individually.
